...
public class CloudSolrSinkTopicConfig extends SolrSinkTopicConfig {
  ...
  protected CloudSolrSinkTopicConfig(ConfigDef subclassConfigDef, Map<String, String> props) {
    super(subclassConfigDef, props);
  }

  public CloudSolrSinkTopicConfig(Map<String, String> props) {
